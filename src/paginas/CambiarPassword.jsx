...
const CambiarPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (password.pwd_nuevo.length<6) {
      setAlerta({
        msg: 'La contraseña debe terner minimo 6 digitos',
        error: true
       })
       return
    };
  ...
  return (
    <>
      ...
      <p className="text-xl mt-5 mb-10 text-center"> Modifica tu {''}<span className="text-indigo-600 font-bold"> Constraseña aqui</span></p>
      ...
      <div className="flex justify-center">
        ...
        {msg && <Alerta alerta={alerta}/>}
            ...
            >
                ...
                <div className="my-3">
                    <label className="uppercase font-bold text-gray-600">confirmar Password</label>
                    <input
                        type="password"
                        className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" 
                        name="pwd_confirmar"
